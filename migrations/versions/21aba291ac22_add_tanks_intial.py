...
Revision ID: 21aba291ac22
Revises: 
Create Date: 2022-06-18 18:11:06.660017
...
def upgrade():
    ...
    op.create_index(op.f('ix_tank_tank_id'), 'tank', ['tank_id'], unique=True)
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_tank_tank_id'), table_name='tank')
    op.drop_table('tank')
    # ### end Alembic commands ###
