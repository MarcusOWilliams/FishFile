"""add new stock layout

Revision ID: a72d8d23705e
Revises: 
Create Date: 2022-07-31 10:19:37.556030
...
def upgrade():
    ...
    sa.Column('year_total', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['stock_name'], ['stock.name'], ),
