...
from app.models import Allele, Photo, User, Fish, Change, Settings, Notification, Reminder, Stock
import atexit
...
def make_shell_context():
    return {'db': db, 'User': User, 'Fish': Fish, 'Change': Change, 'Settings': Settings, 'Notification': Notification, 'Reminder':Reminder, 'Allele':Allele, 'Photo':Photo, 'Stock':Stock}
