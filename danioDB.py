...
from app.models import Allele, User, Fish, Change, Settings, Notification, Reminder
import atexit
...
def make_shell_context():
    return {'db': db, 'User': User, 'Fish': Fish, 'Change': Change, 'Settings': Settings, 'Notification': Notification, 'Reminder':Reminder, 'Allele':Allele}
